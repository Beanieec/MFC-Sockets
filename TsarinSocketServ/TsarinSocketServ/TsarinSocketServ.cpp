...
// TsarinSocketServ.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTsarinSocketServApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTsarinSocketServApp

CTsarinSocketServApp::CTsarinSocketServApp()
{
...
// Единственный объект CTsarinSocketServApp

CTsarinSocketServApp theApp;


// Инициализация CTsarinSocketServApp

BOOL CTsarinSocketServApp::InitInstance()
{
