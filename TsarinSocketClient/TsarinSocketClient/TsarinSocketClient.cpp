...
// TsarinSocketClient.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CTsarinSocketClientApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CTsarinSocketClientApp

CTsarinSocketClientApp::CTsarinSocketClientApp()
{
...
// Единственный объект CTsarinSocketClientApp

CTsarinSocketClientApp theApp;


// Инициализация CTsarinSocketClientApp

BOOL CTsarinSocketClientApp::InitInstance()
{
